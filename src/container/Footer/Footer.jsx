...
const Footer = () => {
  ...
  return (
    <>
      <h2 className='head-text'>Leave me a message</h2>

      <div className='app__footer-cards'>
        <div className='app__footer-card'>
          <img src={images.email} alt="email" />
          <a href="mailto:ukenov.asylhan@gmail.com" className='p-text'>ukenov.asylhan@gmail.com</a>
        </div>
        <div className='app__footer-card'>
          <img src={images.mobile} alt="mobile" />
          <a href="tel: +7 (701) 997-04-79" className='p-text'>+7 (701) 997-04-79</a>
        </div>
      </div>
